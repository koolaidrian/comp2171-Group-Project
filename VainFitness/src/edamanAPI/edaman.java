...
public class edaman {
    ...
    public FoodItem getCaloricValue(String Name, String queryString) {
        ...
        try {
            ...
            Result = parseFoodItem(responseContent.toString(),Name);
       ...
       private FoodItem parseFoodItem(String responseBody,String Name){
            Gson gson;
           ...
           return new FoodItem(Name,calorie.getQuantity(),carbs.getQuantity(),protein.getQuantity(),fat.getQuantity());
       }
    ...
    public String searchCaloricValue(String queryString) {
    	String Result = "";
